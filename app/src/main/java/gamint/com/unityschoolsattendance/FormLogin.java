...
import static gamint.com.unityschoolsattendance.Unboarding.PREFRENCE_MODE_PRIVATE;

public class FormLogin extends AppCompatActivity {
    private SharedPreferences mPrefs;
    private SharedPreferences.Editor editor;
    private boolean singedIn = false, remember = true;
