...
import gamint.com.unityschoolsattendance.utils.LfsJavaWrapperDefinesMinutiaN;
import gamint.com.unityschoolsattendance.utils.storageFile;

import static gamint.com.unityschoolsattendance.BioMiniMain.ARGB2Gray;
...
//            fOut.write(Temp);
    ...
    public boolean EncodeToLFSMinutiae(String fileName) throws Exception {
        int RetVal;
        ...
        if (RetVal != LfsJavaWrapperLibrary.LFS_SUCCESS) {
            Log.d("bippiis", "LFS Unsuccessful with RetVal = " + RetVal + ", Probe Original length = " + Probe1.length + ", MinutiaeNum = " + MinutiaeNum.Get() + " " + GB_AcquisitionOptionsGlobals.LFS_Jw.GetLastErrorString());
